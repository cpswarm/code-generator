...
class ADFReaderTest {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(ADFReaderTest.class.getName());
	...
	public void testADFRead() {
		...
		LOGGER.info("-----------------------------------------------------------------------------------------");
		try (Reader ADFileReader = Files.newBufferedReader(Paths.get(resourceDirectory + INPUT_PATH))) {
